...
const StoragePricingCalculator = () => {
    ...
    const calculations = useMemo(() => {
        const storageCost =
            ((storageGB * storageHours) / 1000) * selectedStorageType.baseStoragePrice * selectedTier.storageMultiplier;
        ...
        const listCost =
            selectedStorageType.hasLists && selectedStorageType.baseListPrice
            ...
            <div className={styles.results}>
                ...
                <div className={styles.costBreakdown}>
                    <div className={styles.costItem}>
                        <span>
                            Storage ({storageGB} GB × {storageHours} hours)
                        </span>

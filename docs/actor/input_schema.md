...
You can also use our [visual input schema editor](https://apifytech.github.io/input-schema-editor-react) to guide you in creation of the INPUT_SCHEMA.json file.

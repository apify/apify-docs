...
Work on your actors does not end when you publish it. Next, you need to promote your new creation and get as much attention as possible from its target user group. The Apify domain's strength is a big plus for organic search rankings. In addition, you need to focus on crafting content according to topics and phrases people search for on Google.

Organic traffic, however, isn't the only channel through which you can get your actor out there. There are many other possibilities such as blog posts and community marketing.
...
The easiest way to identify phrases to focus on is using [Google Keyword planner](https://ads.google.com/aw/keywordplanner/home).
...
> GOOD: Try the [Facebook scraper](https://apify.com/pocesar/facebook-pages-scraper) now. <br/>
...
> GOOD: Need to crawl #Amazon or #Yelp? See my Amazon crawler https://... <br/>

...
![Apify actor input schema example]({{@asset actors/images/input-schema-example.webp}})
...
![Apify actor input schema page function]({{@asset actors/images/input-schema-page-function.webp}})
...
![Apify actor input schema - country input]({{@asset actors/images/input-schema-country.webp}})
...
![Apify actor input schema options]({{@asset actors/images/input-schema-options.webp}})
...
![Apify actor input schema memory]({{@asset actors/images/input-schema-memory.webp}})
...
![Apify actor input schema proxy]({{@asset actors/images/input-schema-proxy.webp}})
...
![Apify actor input schema user object]({{@asset actors/images/input-schema-user.webp}})
...
![Apify actor input schema start urls array]({{@asset actors/images/input-schema-start-urls.webp}})
...
![Apify actor input schema colors array]({{@asset actors/images/input-schema-colors.webp}})

...
Actors usually store their output to a default dataset. The [actor runs endpoint](https://docs.apify.com/api/v2#/reference/actor-runs) lets you get overall info about an actor run's default dataset.

---
title: Actions
description: Send a notification when a specific event occurs in your actor or task run. Dynamically add data to the notification payload at the time of sending the notification.
menuWeight: 8.2
paths:
    - webhooks/actions
---

...
For JavaScript / Node.js applications, the easiest way to access the Apify API is using the [`apify-client`](/docs/api/apify-client-js/latest) NPM package.
...
*   [Documentation for latest version](/docs/api/apify-client-js/latest)
...
The latest version of the API used to manage [Apify actors](./actor) and associated resources. The API enables you to manage:
...
[View API reference](/docs/api/v2)

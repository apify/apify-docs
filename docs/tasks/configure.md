...
![Apify task options]({{@asset tasks/images/options.png}})
<small>Options configuration</small>
...
![Apify task raw input]({{@asset tasks/images/raw-input.png}})
<small>Raw input UI</small>

![Apify task visual input]({{@asset tasks/images/visual-input.png}})
<small>Visual input UI</small>

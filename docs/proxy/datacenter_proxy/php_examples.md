---
title: PHP Examples
description: Learn how to connect to Apify's datacenter proxies from your application using PHP code examples. Configure proxy groups and IP address use.
paths:

...
description: Learn how to connect to Apify's residential proxies from your application using Python 2 and 3 code examples. Configure proxy locations and IP address use.
paths:

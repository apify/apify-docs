---
title: PHP Examples
description: Learn how to connect to Google SERP proxies from your application using PHP code examples. Configure proxy locations and reduce blocking when web scraping.
paths:

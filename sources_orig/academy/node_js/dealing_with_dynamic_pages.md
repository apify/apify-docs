...
Now, let's write some data extraction code to extract each product's data. This should look familiar if you went through the [Data Collection]({{@link web_scraping_for_beginners/data_extraction.md}}) lessons:

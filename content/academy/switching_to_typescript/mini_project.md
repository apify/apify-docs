...
![Can't access the "images" property even though it exists]({{@asset switching_to_typescript/images/we-need-overloads.webp}})
...
![No more error]({{@asset switching_to_typescript/images/no-more-error.webp}})

...
![Network tab results after completing an action on the page which results in the API being called]({{@asset api_scraping/general_api_scraping/images/results-in-network-tab.webp}})
...
![Endpoint found in the Network tab]({{@asset api_scraping/general_api_scraping/images/endpoint-found.webp}})
...
![Breaking down the request url into understandable chunks]({{@asset api_scraping/general_api_scraping/images/analyzing-the-url.webp}})
...
[Next lesson]({{@link api_scraping/general_api_scraping/cookies_headers_tokens.md}}) will be all about cookies, headers, and tokens, and how they're relevant when scraping an API.

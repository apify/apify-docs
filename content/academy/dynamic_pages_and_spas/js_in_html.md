...
![View the target data in the window object using the console in DevTools]({{@asset dynamic_pages_and_spas/images/view-object-in-window.webp}})
...
In our [next lesson]({{@link dynamic_pages_and_spas/js_rendering_and_dynamic_pages.md}}), we'll be taking an in-depth look at what dynamic content is, and how to scrape it reliably.

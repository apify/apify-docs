...
This tutorial shows you how to write a Python [actor]({{@link getting_started/actors.md}}) for scraping the weather forecast from [BBC Weather](https://www.bbc.com/weather) and process the scraped data using [Pandas](https://pandas.pydata.org/).
...
![BBC Weather URL format]({{@asset python/images/bbc-weather-url-format.webp}})
...
![BBC Weather displaying a location with current time between midnight and 5 AM]({{@asset python/images/bbc-weather-after-midnight.webp}})
...
![The timezone offset on the BBC Weather page]({{@asset python/images/bbc-time-offset.webp}})
...
![BBC Weather with the DevTools Inspector open]({{@asset python/images/bbc-weather-devtools.webp}})
...
![Building and running the BBC Weather Scraper actor]({{@asset python/images/bbc-weather-scraper-source.webp}})
...
![Building and running the BBC Weather Parser actor]({{@asset python/images/bbc-weather-parser-source.webp}})

Looking at the results, Honolulu seems like the right choice now, don't you think? 🙂

![Weather prediction plot created by the BBC Weather Parser actor]({{@asset python/images/bbc-weather-prediction.webp}})

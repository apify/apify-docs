...
menuWeight: 5
paths:
    - apify-platform/first-actor/integrating-webhooks
---
...
![Selecting an empty template to start with]({{@asset apify_platform/first_actor/images/select-empty.webp}})
...
![Actor ID in actor settings]({{@asset apify_platform/first_actor/images/actor-settings.webp}})
...
![Configuring a webhook]({{@asset apify_platform/first_actor/images/adding-webhook.webp}})
...
![Webhook succeeded]({{@asset apify_platform/first_actor/images/webhook-succeeded.webp}})

Additionally, we should be able to see that our **filter-actor** was run, and have access to its dataset:

![Dataset preview]({{@asset apify_platform/first_actor/images/dataset-preview.webp}})

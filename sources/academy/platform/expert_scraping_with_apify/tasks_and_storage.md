...
- Read about the [two main storage options](/actors/storage/dataset) on the Apify platform.
- Understand the [crucial differences between named and unnamed storages](/actors/storage/usage#named-and-unnamed-storages).

...
- … and many others, check out for comprehensive list [https://apify.com/templates](https://apify.com/templates)
    ...
    For a step-by-step introduction to creating your first Actor (including tech stack choices and development paths), see [Quick Start](/actors/development/quick-start).

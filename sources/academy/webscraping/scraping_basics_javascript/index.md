...
If you would like to learn about the Apify platform and how it can help you build, run and scale your web scraping and automation projects, see the [Apify platform documentation](/platform), where you'll learn all about Apify serverless infrastructure, proxies, API, scheduling, webhooks and much more.

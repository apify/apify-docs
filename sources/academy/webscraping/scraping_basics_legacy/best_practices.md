...
> On the Apify platform, you can use the [input schema](../../deploying_your_code/input_schema.md) to both validate inputs and generate a clean UI for those using your scraper.

...
3. **What you are scraping** - The same data can be extracted in many ways from a website. You can get the inital HTML or you can use a browser to render the full page or you can reverse engineer internal APIs. Each of those endpoints can be protected differently.

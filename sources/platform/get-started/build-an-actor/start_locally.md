...
slug: /get-started/build-an-actor/locally
---
...
Find more info in the [Input schema](/platform/actors/development/input-output-schemas/input-schema) documentation.

#### Actor's `storage`

The Actor system provides two storage types for files and results: [key-value](/platform/actors/storage/key-value-store) store and [dataset](/platform/actors/storage/dataset).
...
- [Dataset Schema Specification](/platform/actors/development/input-output-schemas/dataset-schema)
- [Key-value Store Schema Specification](/platform/actors/development/input-output-schemas/key-value-store-schema)

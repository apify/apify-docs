...
Before you start building your own Actor, try out a couple of existing Actors from [Apify Store](https://apify.com/store). See the [Running Actors](/actors/running) section for more information on running existing Actors.

:::

## Technology stack

Any code that can run inside of a Docker container can be turned into Apify [Actor](/actors). This gives you freedom in choosing your technical stack, including programming language and technologies.

...
If you use the `country` [parameter](./index.md#username-parameters), the Google proxy location is used if you access a website whose hostname (stripped of `www.`) starts with **google**.

...
- **Get Dataset Items** retrieves items from an Apify [dataset](/actors/storage/dataset):
...
- **Get Key-Value Store Record** retrieves a value from an Apify [key-value store](/actors/storage/key-value-store):

...
> Sets a value to a [Key-value store](/actors/storage/key-value-store).

## Searches

### Fetch dataset items

> Retrieves items from a [dataset](/actors/storage/dataset).
...
> Retrieves value from a [Key-value store](/actors/storage/key-value-store).

...
Setup guides for chat clients and coding agents, such as ChatGPT, Claude Code, Cursor, and Codex, are in the **Agents** category. [Apify agent tools](/agent-tools) compares the MCP server, plugins, and Agent Skills, and links to the guide for every agent.

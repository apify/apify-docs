...
If you're connecting a coding agent rather than picking an integration, start at [Apify agent tools](/agent-tools). It compares the MCP server, plugins, and Agent Skills, and points you at the right setup for your client.

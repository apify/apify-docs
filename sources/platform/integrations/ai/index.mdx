...
The [Claude hub](/platform/integrations/claude) covers Apify integrations across Claude Desktop and the Claude Code CLI on one page.

The [OpenAI hub](/platform/integrations/openai) covers Apify integrations across ChatGPT, the OpenAI Agents SDK, and OpenAI Assistants on one page.

For Google ADK, see the [Google ADK](/platform/integrations/google-adk) page. The full list of AI integrations lives in the sidebar.

...
For Apify in Claude Desktop, see the [Claude Desktop](/platform/integrations/claude-desktop) page. For Google ADK, see the [Google ADK](/platform/integrations/google-adk) page. The full list of AI integrations lives in the sidebar.

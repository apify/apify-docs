...
Download and run the [Apify MCP Server `.mcbp` file](https://github.com/apify/apify-mcp-server/releases/download/v0.4.21/apify-mcp-server.mcpb) for one-click installation.

...
The Apify plugin connects Grok Bot to Apify's library of [Actors](https://apify.com/store) and bundles:
...
1. Browse or search for **Apify**.

    ![Grok Bot plugin search results for apify, showing the Apify plugin card with an Add button](images/grok-bot/plugins-settings.webp)
...
:::caution Shared cloud computer

All Bots on your account share the same cloud computer. Skills that edit files (Actor development, actorization, SDK integration) make changes there - review them before deploying or committing. Files and credentials you place on that computer are visible to every Bot.
...
Open **Settings** > **Plugins** and browse or search for **Apify**. If it still doesn't appear, sign out and back in to the Grok Bot app, then reopen **Plugins**.

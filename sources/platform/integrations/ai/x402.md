...
This direct API flow is experimental and behavior varies between wallets. Use the [Apify MCP server](#use-x402-with-apify-mcp-server) path for the most reliable experience.

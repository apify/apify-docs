...
import Key from "@site/src/components/KeyboardKey/KeyboardKey";
...
1. Open Command Palette (<Key type='CMD' />/<Key type='CTRL' /> + <Key type='Shift' /> + <Key type='P' />) and run _MCP: Open User Configuration_ command.

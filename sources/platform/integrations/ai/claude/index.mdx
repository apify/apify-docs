---
title: Claude
description: Use Apify Actors with Anthropic's Claude - run scrapers, crawlers, and integrations from Claude Desktop and other Anthropic clients via the Apify MCP server.

...
- The [Apify MCP server](/mcp) for searching the Store, running Actors, and retrieving datasets through the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/docs/getting-started/intro).
...
- Each Actor run consumes Apify platform usage from your plan in addition to any Claude usage. See [Billing](/account/billing) for details.

...
and [manage your data](/api/v2#/reference/datasets/item-collection/put-items) using only HTTP requests (or our handy API clients [for JavaScript](/api/client/js/) and [for Python](/api/client/python/)).

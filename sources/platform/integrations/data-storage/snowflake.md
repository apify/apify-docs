...
<!-- ![Snowflake Marketplace listing](../images/snowflake/snowflake-marketplace.png) -->
...
<!-- ![Snowflake External Access Integration setup](../images/snowflake/snowflake-setup-integration.png) -->
...
<!-- ![Snowflake API Token page](../images/snowflake/snowflake-api-token.png) -->
...
<!-- ![Snowflake import dataset selection](../images/snowflake/snowflake-import-dataset-select.png) -->
...
- **Create new table** - the app creates a new table in the `APIFY.DATASETS_EXPORTS` schema in a dedicated database. Select which columns to include, then click **Next: Export**.
    ...
    Alternatively, you can do this through the app's own settings UI.
...
<!-- ![Snowflake export mode selection](../images/snowflake/snowflake-export-mode.png) -->
...
<!-- ![Snowflake Actor selection](../images/snowflake/snowflake-run-actor-select.png) -->
...
<!-- ![Snowflake Actor run status](../images/snowflake/snowflake-run-actor-status.png) -->

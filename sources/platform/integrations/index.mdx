...
If you are building a service and your users could benefit from integrating with Apify or vice-versa then read the [integrate with Apify](./integrate-with-apify.md).
...
<CardGrid>
    ...
    <Card
        title="GitHub"
        desc="Build Actors from GitHub repositories and create issues when runs fail."

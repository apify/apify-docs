...
<CardGrid>
    ...
    <Card
        title="Devin CLI"
        desc="Install the Apify plugin in Devin to discover, run, and build Actors from the terminal."
        to="/integrations/devin"
        imageUrl="/img/platform/integrations/devin.svg"
        imageUrlDarkTheme="/img/platform/integrations/devin-white.svg"
        smallImage
    />
    <Card
        title="VS Code"

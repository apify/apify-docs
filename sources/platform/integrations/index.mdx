...
<CardGrid>
    ...
    <Card
        title="ZCode"
        desc="Install the Apify plugin in ZCode to discover, run, and build Actors from the coding agent."
        to="/integrations/zcode"
        imageUrl="/img/platform/integrations/zcode.svg"
        imageUrlDarkTheme="/img/platform/integrations/zcode-white.svg"
        smallImage
    />
    <Card
        title="Kimi Code CLI"

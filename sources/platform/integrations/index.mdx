...
<CardGrid>
    ...
    <Card
        ...
        desc="Install the Apify plugin in the GitHub Copilot CLI or desktop app to discover, run, and build Actors."
    ...
    <Card
        title="Kimi Code CLI"
        desc="Install the Apify plugin in Kimi Code CLI to interact with Apify from the CLI."
    ...
    <Card
        title="Grok Bot"
        desc="Install the Apify plugin in Grok Bot to discover, run, and build Actors from chat."
        to="/integrations/grok-bot"
        imageUrl="/img/platform/integrations/grok-bot.svg"
        imageUrlDarkTheme="/img/platform/integrations/grok-bot-white.svg"
        smallImage
    />
    <Card
        title="VS Code"

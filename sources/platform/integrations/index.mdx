...
<CardGrid>
    ...
    <Card
        title="Factory"
        desc="Install the Apify plugin in Factory Droid to discover, run, and build Actors from the terminal."
        to="/integrations/factory"
        imageUrl="/img/platform/integrations/factory-ai-dark.svg"
        imageUrlDarkTheme="/img/platform/integrations/factory-ai-white.svg"
        smallImage
    />
    <Card
        title="Kimi Code CLI"

...
<CardGrid>
    ...
    <Card
        ...
        desc="Install the Apify plugin in DeepSeek Harness to interact with Apify from the terminal or web GUI."
        to="/integrations/deepseek-harness"
        imageUrl="/img/platform/integrations/deepseek.svg"
        smallImage
    />
</CardGrid>

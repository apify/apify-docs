...
slug: /publishing-and-monetization/monetize/rental
sidebar_position: 1
---
...
We recommend using the [pay-per-result](/platform/publishing-and-monetization/publish/monetize/pay-per-result) or [pay-per-event](/platform/publishing-and-monetization/publish/monetize/pay-per-event) models instead.

...
slug: /publishing-and-monetization/test
sidebar_position: 3
---
...
The test runs the Actor with its default input (defined by the [**prefill**](https://docs.apify.com/platform/using-actors/development/actor-definition/input-schema/specification/v1#prefill-vs-default-vs-required) option in the input schema file)
...
For more information, see the [automated testing](/platform/building-actors/automated-tests) section.

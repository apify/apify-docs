...
description: "Share Actors and earn from the creator economy"
sidebar_position: 1
...
1. [Development](/platform/building-actors).
2. [Publication](./publishing/publish) and set up of [monetization](./publishing/monetize).
3. [Testing](/platform/building-actors/automated-tests).
...
To learn more  visit our [Actors in Store](https://docs.apify.com/platform/using-actors/running/actors-in-store#pricing-models) page.
...
Ensure periodic testing, either manually or by [setting up automatic testing](/platform/building-actors/automated-tests) and [monitoring](https://apify.com/apify/monitoring). This can help prevent users from encountering issues with your Actor.

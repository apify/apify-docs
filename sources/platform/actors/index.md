...
Actors can be [public](./running/store.md) or private. Private actors are yours to use and keep; no one will see them if you don't want them to. Public actors are [available to everyone](./running/store.md) in [Apify Store](https://apify.com/store). You can make them free to use, or you can [charge for them](https://blog.apify.com/make-regular-passive-income-developing-web-automation-actors-b0392278d085/).

## Section overview

This section covers the main 3 topics when it comes to Apify Actors:
- [Running actors](./running) - how to run your actors and actors from [Apify Store](https://apify.com/store). This part also covers the configuration, pricing, and usage cost.
- [Development](./development) - an intro into how to develop your own actor.
- [Publishing and momnetization](./publishing) - learn how to share your actors with other users and monetize them.

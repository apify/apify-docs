...
This section covers the main 3 points when it comes to Apify Actors:
- [Running actors](./running) - how to run your own actors or actors from [Apify Store](https://apify.com/store). This part also covers the configuration and pricing.
- [Development](./development) - how to develop your own actor.
- [Publishing and momnetization](./publishing) - how to share your actor with other users and monetize it.

...
Apify recommends using the synthetic Actor start event in PPE Actors. It benefits both you and your users.
...
For existing Actors, you can add this event manually in the **Actor pricing** step of the [monetization setup](/platform/actors/publishing/monetize#set-up-monetization).

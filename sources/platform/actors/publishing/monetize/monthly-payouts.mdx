...
In order to comply with anti-money laundering (AML) regulations, Apify verifies that everyone receiving payments is who they say they are, whether they are an individual or a company. This requirement is part of Apify's [Terms and Conditions](/legal/store-publishing-terms-and-conditions).
...
- Upload a clear, high-resolution photo of the original document. Screenshots, paper copies, or damaged documents are automatically rejected.

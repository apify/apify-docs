...
menuTitle: Publishing and monetization
...
2. [Publication](./publish) and set up of [monetization](./monetize).
...
If your code is publicly available on [GitHub](https://github.com), its quality is a priority since your actors may be a new user's first and critical contact with Apify. Code should be open to changes and updates – don't fear to refactor. Beware of breaking changes, though! If you make a breaking change, please get in touch with us ahead of time at community@apify.com, and we will help you to communicate it to your users.
...
Ensure periodic testing. You can either do it yourself or [set up automatic tests](../development/testing_and_maintenance.md) / [monitoring](https://apify.com/apify/monitoring). Try to prevent your users from coming to you with the issues.

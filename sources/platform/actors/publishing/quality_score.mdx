...
- The _Apify MCP server_ `search-actors` tool used by external AI agents. See [Apify MCP server](/mcp).
...
![Actor quality dashboard in Apify Console showing an Actor's quality score with passed checks and improvement suggestions](./images/actor-quality-score.webp)

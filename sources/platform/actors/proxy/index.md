...
You can use proxies in your [Actors](../index.mdx) or any other application that supports HTTP proxies. Apify Proxy monitors the health of your IP pool and intelligently rotates addresses to prevent IP address-based blocking.
...
Usage of Apify Proxy means just a couple of lines of code, thanks to the [Apify SDKs](/sdk):
...
<CardGrid>
    ...
    <Card
        ...
        to="/platform/actors/proxy/google-serp-proxy"
    />
</CardGrid>

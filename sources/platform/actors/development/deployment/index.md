...
If you want to deploy an Actor in a different way, you need to first manually create the Actor in [Apify Console](https://console.apify.com/actors). Then switch its source type:

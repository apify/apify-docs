...
sidebar_position: 2
slug: /actors/development/input-output-schemas/dataset-schema/multiple-datasets
---
...
See the full [Actor schema reference](../actor_definition/actor_json.md#reference).
...
The Storage tab shows data but doesn't surface it clearly to end users. To present datasets more clearly, define an [output schema](./output_schema.md).
...
[Read more](./output_schema.md#how-templates-work) about how templates work.

...
slug: /actors/development/input-output-schemas/key-value-store-schema
---
...
![Storages tab in Run](../actor_definition/key_value_store_schema/images/kv-store-schema-example-run.png)

The tabs also appear in the storage detail view:

![Storage detail](../actor_definition/key_value_store_schema/images/kv-store-schema-example-storage.png)

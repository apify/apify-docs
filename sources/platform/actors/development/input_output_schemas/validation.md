...
slug: /actors/development/input-output-schemas/dataset-schema/validation
---
...
You can use them in [monitoring](/platform/actors/running/monitoring#alert-configuration).

...
Use the following prompt in your AI coding assistant such as [Antigravity](https://antigravity.google/), [Cursor](https://www.cursor.com/), [Claude Code](https://www.claude.com/product/claude-code) or [GitHub Copilot](https://github.com/features/copilot):
...
5. Add the following to the configuration file:
    ...
    ```
    > _Apify API token_ - Get your API token from the **Integrations** section in [Apify Console](https://console.apify.com/account#/integrations).

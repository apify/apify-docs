---
title: Source code
description: Learn about Actor source code structure, the metamorph feature, or how to run a web server inside of an Actor.
slug: /actors/development/actor-definition/source-code
---

**Learn about Actor source code structure, the metamorph feature, or how to run a web server inside of an Actor.**

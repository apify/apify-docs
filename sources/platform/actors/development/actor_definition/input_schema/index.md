...
Next, let's take a look at [input schema specification](./specification.md), and the possibility of using input schema to enable useres to pass [secrets](./secret_input.md).

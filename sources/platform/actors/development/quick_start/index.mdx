...
title: Quick start
sidebar_position: 1
description: Create your first actor using Apify Console IDE or locally.
slug: /actors/development/quick-start
---

# Developement a quick start
...
**But to fully benefit from running on the top of the Apify platform, we recommend you to choose either Javascript/Node.js or Python, where Apify provides you with first-level support in terms of its SDK, API clients, and learning materials.
**

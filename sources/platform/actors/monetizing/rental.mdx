---
title: Actor rental pricing model
sidebar_label: Rental pricing model
description: Learn how to monetize your Actor with the rental pricing model, offering a free trial and a flat monthly fee, and understand how profit is calculated.
...
The growing limitation is AI compatibility. [Apify's MCP server](/mcp) explicitly excludes rental Actors from search results, making them invisible to AI systems that dynamically select and execute tools. This significantly reduces your Actor's discoverability in AI workflows.

...
If your Actor generates negative profit, [follow the recommendations](/actors/publishing/monetize/pay-per-event#avoid-negative-profit) before increasing the price.

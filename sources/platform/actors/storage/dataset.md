...
You can access a dataset from any [Actor](../index.mdx) or [task](../running/tasks.md) run as long as you know its _name_ or _ID_.
...
See the [Storage overview](/platform/actors/storage/usage#sharing-storages-between-runs) for details on sharing storages between runs.

...
> Unnamed request queues expire after 7 days unless otherwise specified.<br/> > [Learn more](/actors/storage/usage#named-and-unnamed-storages)
...
[retention period](/actors/storage/usage#named-and-unnamed-storages)) and [access rights](../collaboration/index.md) using the **Share** button.

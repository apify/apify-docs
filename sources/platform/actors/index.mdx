...
- A **Dockerfile** that specifies where the Actor's source code is, how to build it, and how to run it.
- **Documentation** in the form of a README.md file.
- **Input and output schemas** that describe the Actor's required input and the results it produces.
- Access to an out-of-the-box **storage system** for Actor data, results, and files.
- **Metadata** such as the Actor's name, description, author, and version.

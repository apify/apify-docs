...
You can grant [access rights](../account/index.md) to other Apify users to view or modify your storages. Check the [full list of permissions](../account/list_of_permissions.md).

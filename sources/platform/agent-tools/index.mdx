...
- For a chat client or an agent framework, connect the [MCP server](/mcp) directly. LangChain, CrewAI, the Vercel AI SDK, and other frameworks have their own guides under [AI integrations](/integrations/ai).
...
| Any other MCP-capable client | [Apify MCP server](/mcp) |
...
- [Apify MCP server](/mcp) - full MCP reference, including tool selection and production practices
